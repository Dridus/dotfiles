  ...
  outputs =
    ...
    }@inputs:
    {
      homeConfigurations = nixpkgs.lib.fix (self: {
        ross = self."ross@ameratasu";
        "ross@Ameratasu" = self."ross@ameratasu";
        "ross@ameratasu" = home-manager.lib.homeManagerConfiguration {
            ...
            [
              {
                ...
                dotfiles = {
                  ...
                  homeFlake = "git+file:///Users/ross/1st/dotfiles?dir=homes/ameratasu";
